...
DATA SEGMENT
    ...
    MSG2   DB  0DH , 0AH , 0DH , 0AH , "CIPHER TEXT (ENCRYPTED TEXT) : $"          ; PROMT STRING TO DISPLAY OUTPUT
    ...
    MSG5   DB  0DH , 0AH , 0DH , 0AH , "PLAIN TEXT (DECRYPTED TEXT) : $"           ; PROMT STRING TO DISPLAY OUTPUT
